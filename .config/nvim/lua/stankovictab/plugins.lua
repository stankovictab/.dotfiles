...
vim.g.mkdp_markdown_css = '~/.config/nvim/lua/stankovictab/specifics/mkdp_mgz.css'            -- CSS file to style the preview
vim.g.mkdp_highlight_css = '~/.config/nvim/lua/stankovictab/specifics/mkdp_mgz_highlight.css' -- CSS file to style the preview
