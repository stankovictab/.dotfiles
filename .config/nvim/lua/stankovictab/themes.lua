...
-- vim.g.mgz_italic_comments = true    -- Whether to render comments in italics or not. Default is false.
vim.g.mgz_darker_comments = true     -- Whether to render comments in a darker color or not. Default is false.
