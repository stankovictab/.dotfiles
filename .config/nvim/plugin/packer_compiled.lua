...
_G.packer_plugins = {
  ...
  ["impatient.nvim"] = {
    loaded = true,
    path = "/home/stankovictab/.local/share/nvim/site/pack/packer/start/impatient.nvim",
  ...
  ["nvim-web-devicons"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/stankovictab/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-web-devicons', 'toggleterm.nvim', 'alpha-nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
